...
const isRequestsHomePath = computed(() => route.path === '/bookings/requests');
  ...
  <article id="parent-container" class="fade-in">
    ...
    <section class="middle-section" :style="dynamicWidthStyle">
      <SummaryCardsRow>
        ...
        <DisplayCard :data-figure="124" data-text="Completed Requests" />
      </SummaryCardsRow>
    </section>
    ...
    <section class="bottom-section" :style="dynamicWidthStyle">
      <article class="head-section">
        <div class="menu-items">
          ...
          <router-link :class="{'active-border': isCompletedPath}" @click="handleClick" to="/bookings/requests/completed">
            {{'Completed Requests'}}
          </router-link>
        </div>
